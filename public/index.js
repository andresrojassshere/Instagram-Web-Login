...
class AppContainer extends HTMLElement {
    ...
    connectedCallback() {
        var _a;
        this.render();
        const signup = (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector("app-register");
        signup === null || signup === void 0 ? void 0 : signup.addEventListener("login-success", () => {
